...
<div class="yotpo bottomLine"
	...
	{if $product->condition}
		...
		<!-- left infos-->
        <div class="pb-left-column col-xs-12 {if isset($warehouse_vars.product_right_block) && $warehouse_vars.product_right_block && !$content_only}show-right-info col-md-3 col-lg-3{else}col-md-3 col-lg-3{/if}">
			<!-- product img-->
			...
			{/if}
				...
				<ul id="usefull_link_block" class="clearfix no-print">
					...
					{if isset($have_image) && $have_image && !$jqZoomEnabled}{/if}
				</ul>
			{/if}
		...
		<div class="pb-center-column col-xs-12 {if isset($warehouse_vars.product_right_block) && $warehouse_vars.product_right_block && !$content_only}col-md-6 col-lg-6{else}col-md-6 col-lg-6{/if}">
			{if isset($warehouse_vars.headings_center) && !$warehouse_vars.headings_center}
...
{if isset($product) && $product->customizable}<li class="customizationsTab"><a href="#customizationsTab" data-toggle="tab">{l s='Product customization'}</a></li>{/if}
