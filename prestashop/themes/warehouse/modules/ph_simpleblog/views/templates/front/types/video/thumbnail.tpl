...
{if isset($post.banner) && Configuration::get('PH_BLOG_DISPLAY_THUMBNAIL')}
	<div class="post-thumbnail">
		<a href="#simpleblog-post-{$post.id_simpleblog_post|intval}-video" title="{l s='Permalink link to' mod='ph_simpleblog'} {$post.title|escape:'html':'UTF-8'}">
...
<div id="simpleblog-post-{$post.id_simpleblog_post|intval}-video" style="display: none;">
	{$post.video_code}
</div>