...
function updateCartSummary(json)
{
	...
	for (i in product_list)
	{
        ...
        /* MBD: update tax column 02.12.14 */
        var product = product_list[i];
        var product_tax = Math.round((product.price_wt - product.price) * 100 / product.price);
        $('#product_tax_' + product_list[i].id_product).html('<span class="tax">' + product_tax + '%</span>');
