<?php /* Smarty version Smarty-3.1.14, created on 2014-10-14 13:51:37
         compiled from "/home2/topgourm/public_html/themes/warehouse/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1089965451543d0e49867972-60385910%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fc86906d1a3dc666b3efe65aec9896dbd7a2b0e0' => 
    array (
      0 => '/home2/topgourm/public_html/themes/warehouse/header.tpl',
      1 => 1412678492,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1089965451543d0e49867972-60385910',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_543d0e499c9627_37756637',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_543d0e499c9627_37756637')) {function content_543d0e499c9627_37756637($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include '/home2/topgourm/public_html/tools/smarty/plugins/function.implode.php';
?>
	<!DOCTYPE HTML>
...
">
		...
		<?php if ($_smarty_tpl->tpl_vars['have_image']->value[0]){?>
		<meta property="og:image" content="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['cover']->value['id_image'],'large_default');?>
">
		<?php }else{ ?>
...
<?php }?><?php if ($_smarty_tpl->tpl_vars['hide_left_column']->value){?> hide-left-column<?php }?><?php if ($_smarty_tpl->tpl_vars['hide_right_column']->value){?> hide-right-column<?php }?><?php if (!$_smarty_tpl->tpl_vars['hide_left_column']->value){?> show-left-column<?php }?><?php if (!$_smarty_tpl->tpl_vars['hide_right_column']->value){?> show-right-column<?php }?> <?php if (isset($_smarty_tpl->tpl_vars['content_only']->value)&&$_smarty_tpl->tpl_vars['content_only']->value){?> content_only<?php }?> lang_<?php echo $_smarty_tpl->tpl_vars['lang_iso']->value;?>
  <?php if (isset($_smarty_tpl->tpl_vars['warehouse_vars']->value['is_rtl'])&&$_smarty_tpl->tpl_vars['warehouse_vars']->value['is_rtl']){?> is_rtl<?php }?>">
...
<?php }?>
				...
				<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'maxHeader'),$_smarty_tpl);?>
...
<?php }?><?php }?>
		<div class="columns-container">
			<div id="columns" class="container">
				...
				<?php if (isset($_smarty_tpl->tpl_vars['warehouse_vars']->value['breadcrumb_width'])&&$_smarty_tpl->tpl_vars['warehouse_vars']->value['breadcrumb_width']==1){?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./breadcrumb.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php }?>
				<?php }?>
