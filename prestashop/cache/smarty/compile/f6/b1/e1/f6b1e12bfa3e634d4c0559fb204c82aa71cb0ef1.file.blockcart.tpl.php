<?php /* Smarty version Smarty-3.1.14, created on 2014-09-24 10:20:57
         compiled from "/home2/topgourm/public_html/themes/ikon/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:139839477354227ee9d6c173-28476188%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f6b1e12bfa3e634d4c0559fb204c82aa71cb0ef1' => 
    array (
      0 => '/home2/topgourm/public_html/themes/ikon/modules/blockcart/blockcart.tpl',
      1 => 1411546792,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '139839477354227ee9d6c173-28476188',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54227eea116252_49318162',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54227eea116252_49318162')) {function content_54227eea116252_49318162($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home2/topgourm/public_html/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_function_counter')) include '/home2/topgourm/public_html/tools/smarty/plugins/function.counter.php';
?>
<!-- MODULE Block cart -->
...
" rel="nofollow">
			<span class="orbit-active ajax_cart_quantity<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value==0){?> unvisible<?php }?>"><?php echo $_smarty_tpl->tpl_vars['cart_qties']->value;?>
</span>
			<span class="orbit-active ajax_cart_product_txt<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value!=1){?> unvisible<?php }?>"><?php echo smartyTranslate(array('s'=>'item','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
			<span class="orbit-active ajax_cart_product_txt_s<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value<2){?> unvisible<?php }?>"><?php echo smartyTranslate(array('s'=>'items','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
			...
			<span class="orbit ajax_cart_no_product<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value>0){?> unvisible<?php }?>"><?php echo smartyTranslate(array('s'=>'0','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
