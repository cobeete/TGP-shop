<?php /* Smarty version Smarty-3.1.14, created on 2014-10-11 10:26:49
         compiled from "/home2/topgourm/public_html/themes/warehouse/order-opc.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20207424715438e9c91d4802-70452418%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7ca67211d0267de40f4f720845782308f71880da' => 
    array (
      0 => '/home2/topgourm/public_html/themes/warehouse/order-opc.tpl',
      1 => 1412678492,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20207424715438e9c91d4802-70452418',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5438e9c9313c95_47298349',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5438e9c9313c95_47298349')) {function content_5438e9c9313c95_47298349($_smarty_tpl) {?>
...
<?php }else{ ?>
	<?php if ($_smarty_tpl->tpl_vars['productNumber']->value){?>
		...
		<?php }?>
	<?php if (!$_smarty_tpl->tpl_vars['isLogged']->value){?><div id="hider_opc">	<?php }?>
		<!-- Carrier -->
		...
		<!-- END Payment -->
	<?php if (!$_smarty_tpl->tpl_vars['isLogged']->value){?></div><?php }?>
	<?php }else{ ?>
		<?php $_smarty_tpl->_capture_stack[0][] = array('path', null, null); ob_start(); ?><?php echo smartyTranslate(array('s'=>'Your shopping cart'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
